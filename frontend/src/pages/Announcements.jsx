      ...
      <div className="max-w-5xl mx-auto px-4 relative z-10">
        <header className="mb-20 text-center">
          ...
          <p className="text-xl text-gray-500 font-medium max-w-2xl mx-auto tracking-tight">
            Mantente al tanto de todas las actualizaciones, eventos y cambios
            críticos dentro del ecosistema de La Palmilla RP.
          </p>
        </header>
          ...
          {loading ? (
            ...
            <div className="glass-card rounded-[3rem] p-20 border border-white/5 text-center">
              ...
              <p className="text-gray-500">
                Estamos preparando grandes cosas. ¡Vuelve pronto!
              </p>
            </div>
          ) : (
            news.map((item, i) => {
                  ...
                  <div className="flex flex-col md:flex-row gap-8 items-start relative z-10">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-4 mb-3">
                        ...
                        <span
                          className={`px-3 py-1 rounded-full text-[10px] font-black text-white uppercase tracking-widest ${item.category === "Alert" ? "bg-primary" : item.category === "Event" ? "bg-secondary" : "bg-blue-500"}`}
                        >
                          {item.category}
                        </span>
                      </div>
