        ...
        <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center py-20 px-4 relative overflow-hidden">
            ...
            >
                <div className="flex flex-col items-center mb-10 text-center">
                    ...
                    <h1 className="text-4xl font-display font-black text-white italic tracking-tighter uppercase mb-2">Acceso <span className="text-secondary">Seguro</span></h1>
                    <p className="text-gray-500 font-medium whitespace-nowrap">Gestiona tus activos y recompensas premium.</p>
                </div>

                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="relative group">
                        <Mail className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-600 group-focus-within:text-secondary transition-colors" size={20} />
                        <input
                            type="email"
                    ...
                    <div className="relative group">
                        <Lock className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-600 group-focus-within:text-secondary transition-colors" size={20} />
                        <input
                            type="password"
                ...
                <div className="mt-10 pt-8 border-t border-white/5 text-center">
                    <button className="w-full flex items-center justify-center gap-3 bg-[#5865F2] hover:bg-[#4752C4] text-white p-4 rounded-2xl font-bold transition-all mb-8">
                        <Gamepad2 size={20} /> Discord Login
                    </button>

                    <p className="text-gray-500 text-sm font-medium">
                        ¿Nuevo en la ciudad? <Link to="/register" className="text-secondary hover:underline font-black">Crea tu cuenta aquí</Link>
                    </p>
                </div>
            </motion.div>
        </div>
