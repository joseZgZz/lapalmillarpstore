            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="flex gap-4">
                        <button
                            type="button"
                            onClick={() => setFormData({ ...formData, platform: "PC" })}
                            className={["flex-1 py-4 rounded-2xl font-black text-sm uppercase tracking-widest border transition-all", formData.platform === "PC" ? "bg-primary text-white border-primary shadow-lg shadow-primary/20" : "bg-white/5 border-white/10 text-gray-500 hover:text-white"].join(" ")}
                        >
                            🖥️ JUEGO EN PC
                        </button>
                        <button
                            type="button"
                            onClick={() => setFormData({ ...formData, platform: "Consola" })}
                            className={["flex-1 py-4 rounded-2xl font-black text-sm uppercase tracking-widest border transition-all", formData.platform === "Consola" ? "bg-secondary text-black border-secondary shadow-lg shadow-secondary/20" : "bg-white/5 border-white/10 text-gray-500 hover:text-white"].join(" ")}
                        >
                            🎮 CONSOLA
                        </button>
                    </div>
